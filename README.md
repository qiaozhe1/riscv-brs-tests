...
This item is a firmware automated detection kit, designed to simplify the construction process of related test items. Currently, the included test projects are [edk2-test](https://github.com/tianocore/edk2-test) and [SBI-test](https://gitlab.com/kvm-unit-tests/kvm-unit-tests.git).
...
| qemu      | https://github.com/qemu/qemu.git                       | stable-8.0                               |
